                            ...
                            <div class="contact-info">
                                ...
                                <div class="contact-info-content">
                                    ...
                                    <p><a href="https://live.themewild.com/cdn-cgi/l/email-protection"
                                            class="__cf_email__"
                                            data-cfemail="5c35323a331c39243d312c3039723f3331">[email&#160;protected]</a>
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 align-self-center">
                            <div class="contact-img">
                                <img src="{{asset('frontend-assets/img/contact/01.jpg')}}" alt>
                            </div>
                        </div>
                        <div class="col-lg-6 align-self-center">
                            <div class="contact-form">
                                ...
                                <form method="post" action="https://live.themewild.com/taxica/assets/php/contact.php"
                                    id="contact-form">
                                    <div class="row">
                                        <div class="col-md-6">
