            ...
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    <div class="banner-txt text-center">
                        <p class="lead text-info">Book your rider Today! Got <sup
                                class="bg-primary text-info p-2 rounded-3  ">10% off</sup></p>
                        ...
                        <form action="#" class="mt-4 pickup-form mt-5">
                            <div class="d-sm-flex align-items-center justify-content-between">
                                ...
                                <a href="{{url('/car-list')}}" class="btn btn-primary rounded-2">Find a Taxi <i
        ...
        <div class="road-bg position-relative" style="background-image: url('frontend-assets/images/road-run.png')">
            <div class="container">
                <div class="d-flex justify-content-between position-relative">
                    <img src="{{asset('frontend-assets/images/icons/taxi-r2.png')}}" alt
                         class="img-fluid anim-move move-3">
