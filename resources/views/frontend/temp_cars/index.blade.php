                ...
                <div class="header-top-wrapper">
                    <div class="header-top-left">
                        <div class="header-top-contact">
                            <ul>
                                <li><a
                                        href="https://live.themewild.com/cdn-cgi/l/email-protection#7811161e17381d00191508141d561b1715"><i
                                            class="far fa-envelopes"></i>
                                        <span class="__cf_email__"
                                            data-cfemail="80e9eee6efc0e5f8e1edf0ece5aee3efed">[email&#160;protected]</span></a>
                                </li>
    ...
    <main class="main">
        ...
        <div class="hero-section">
            <div class="hero-slider owl-carousel owl-theme">
                <div class="hero-single" style="background: url({{asset('frontend-assets/img/slider/slider-1.jpg')}})">
                    <div class="container">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="about-left wow fadeInLeft" data-wow-delay=".25s">
                            <div class="about-img">
                                <img src="{{asset('frontend-assets/img/about/01.png')}}" alt>
                            </div>
                            <div class="about-experience">
                                <div class="about-experience-icon">
                                    <img src="{{asset('frontend-assets/img/icon/taxi-booking.svg')}}" alt>
                                </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-4">
                        <div class="service-item wow fadeInUp" data-wow-delay=".25s">
                            ...
                            <div class="service-icon">
                                <img src="{{asset('frontend-assets/img/icon/taxi-booking-1.svg')}}" alt>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="service-item wow fadeInUp" data-wow-delay=".50s">
                            ...
                            <div class="service-icon">
                                <img src="{{asset('frontend-assets/img/icon/city-taxi.svg')}}" alt>
                            </div>
                            <div class="service-content">
                                <h3 class="service-title">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="service-item wow fadeInUp" data-wow-delay=".75s">
                            <div class="service-img">
                                <img src="{{asset('frontend-assets/img/service/03.jpg')}}" alt>
                            </div>
                            <div class="service-icon">
                                <img src="{{asset('frontend-assets/img/icon/airport.svg')}}" alt>
                            </div>
                            <div class="service-content">
                                <h3 class="service-title">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="service-item wow fadeInUp" data-wow-delay=".25s">
                            <div class="service-img">
                                <img src="{{asset('frontend-assets/img/service/04.jpg')}}" alt>
                            </div>
                            <div class="service-icon">
                                <img src="{{asset('frontend-assets/img/icon/business.svg')}}" alt>
                            </div>
                            <div class="service-content">
                                <h3 class="service-title">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="service-item wow fadeInUp" data-wow-delay=".50s">
                            <div class="service-img">
                                <img src="{{asset('frontend-assets/img/service/05.jpg')}}" alt>
                            </div>
                            <div class="service-icon">
                                <img src="{{asset('frontend-assets/img/icon/taxi-2.svg')}}" alt>
                            </div>
                            <div class="service-content">
                                <h3 class="service-title">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="service-item wow fadeInUp" data-wow-delay=".75s">
                            <div class="service-img">
                                <img src="{{asset('frontend-assets/img/service/06.jpg')}}" alt>
                            </div>
                            <div class="service-icon">
                                <img src="{{asset('frontend-assets/img/icon/taxi.svg')}}" alt>
                            </div>
                            <div class="service-content">
                                <h3 class="service-title">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-sm-6">
                            <div class="counter-box">
                                <div class="icon">
                                    <img src="{{asset('frontend-assets/img/icon/taxi-1.svg')}}" alt>
                                </div>
                                <div>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="counter-box">
                                <div class="icon">
                                    <img src="{{asset('frontend-assets/img/icon/happy.svg')}}" alt>
                                </div>
                                <div>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="counter-box">
                                <div class="icon">
                                    <img src="{{asset('frontend-assets/img/icon/driver.svg')}}" alt>
                                </div>
                                <div>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="counter-box">
                                <div class="icon">
                                    <img src="{{asset('frontend-assets/img/icon/trip.svg')}}" alt>
                                </div>
                                <div>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3">
                        <div class="feature-item wow fadeInUp" data-wow-delay=".25s">
                            <div class="feature-icon">
                                <img src="{{asset('frontend-assets/img/icon/taxi-safety.svg')}}" alt>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="feature-item mt-lg-5 wow fadeInDown" data-wow-delay=".25s">
                            <div class="feature-icon">
                                <img src="{{asset('frontend-assets/img/icon/pickup.svg')}}" alt>
                            </div>
                            <div class="feature-content">
                                <h4>Fast Pickup</h4>
                                <p>There are many variations of majority have suffered alteration in some form injected
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="feature-item wow fadeInUp" data-wow-delay=".25s">
                            <div class="feature-icon">
                                <img src="{{asset('frontend-assets/img/icon/money.svg')}}" alt>
                            </div>
                            <div class="feature-content">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="feature-item mt-lg-5 wow fadeInDown" data-wow-delay=".25s">
                            <div class="feature-icon">
                                <img src="{{asset('frontend-assets/img/icon/support.svg')}}" alt>
                            </div>
                            <div class="feature-content">
                                <h4>24/7 Support</h4>
                                <p>There are many variations of majority have suffered alteration in some form injected
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="rate-item wow fadeInUp" data-wow-delay=".25s">
                            <div class="rate-header">
                                <div class="rate-img">
                                    <img src="{{asset('frontend-assets/img/rate/01.png')}}" alt>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="choose-content">
                            ...
                            <div class="choose-img wow fadeInUp" data-wow-delay=".25s">
                                <img src="{{asset('frontend-assets/img/choose/01.png')}}" alt>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="choose-content-wrapper wow fadeInRight" data-wow-delay=".25s">
                            ...
                            <div class="choose-item mb-lg-0">
                                ...
                                <div class="choose-item-icon">
                                    <img src="{{asset('frontend-assets/img/icon/taxi-location.svg')}}" alt>
                                </div>
                                <div class="choose-item-info">
                    ...
                    <div class="col-lg-6">
                        <div class="faq-right">
                            ...
                            <div class="faq-img mt-3">
                                <img src="{{asset('frontend-assets/img/faq/01.jpg')}}" alt>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="partner-slider owl-carousel owl-theme">
                    <div class="partner-item">
                        <div class="partner-img">
                            <img src="{{asset('frontend-assets/img/partner/01.png')}}" alt>
                        </div>
                    </div>
                    <div class="partner-item">
                        <div class="partner-img">
                            <img src="{{asset('frontend-assets/img/partner/02.png')}}" alt>
                        </div>
                    </div>
                    <div class="partner-item">
                        <div class="partner-img">
                            <img src="{{asset('frontend-assets/img/partner/03.png')}}" alt>
                        </div>
                    </div>
                    <div class="partner-item">
                        <div class="partner-img">
            ...
            <div class="container">
                <div class="download-wrapper">
                    ...
                    <div class="download-img">
                        <img src="{{asset('frontend-assets/img/download/01.png')}}" alt>
                    </div>
                </div>
            </div>
        </div>
