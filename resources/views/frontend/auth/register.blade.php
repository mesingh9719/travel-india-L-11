                                                ...
                                                <div class="col-12 col-lg-12 ml-auto mr-auto mb-4">
                                                    <div class="multisteps-form__progress">
                                                        <button class="multisteps-form__progress-btn js-active"
                                                            type="button" title="User Info">Persnal Details</button>
                                                        <button class="multisteps-form__progress-btn" type="button"
                                                            title="Address">Document</button>
                                                        <button class="multisteps-form__progress-btn" type="button"
                                                            title="Order Info"> Vehicle Details </button>
                                                        <button class="multisteps-form__progress-btn" type="button"
                                                            title="Comments">Bank Details</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--form panels-->
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                        <div class="form-check">
                                                                            <input class="form-check-input" type="checkbox" id="same_as_business" onchange="getCheckboxValue()">
                                                                ...
                                                                <div class="form-row mt-4">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <button class="btn  js-btn-prev ml-auto"
                                                                            type="button" title="Prev"  style="float: left; margin:5px;background-color:#111111; color:#fff"> <i
                                                                            class="fas fa-arrow-left"></i> previous</button>
                                                                        <button
                                                                            class="btn  btn-warning  js-btn-next mr-auto"
                                                                            type="button" title="Next"  style="float: right; margin:5px;"> Next <i
                                                                            class="fas fa-arrow-right"></i></button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="multisteps-form__content">
                                                                    ...
                                                                    <div class="row" id="dynamic_field">
                                                                        ...
                                                                        <div class="form-group col-lg-5"><label>Upload
                                                                                ...
                                                                                required></div>
                                                                        <div class="form-group col-lg-2 mt-4"><button
                                                                                type="button" name="add" id="add"
                                                                                class="btn btn-warning mt-4">+</button>
                                                                        </div>
                                                                    </div>
                                                                

                                                                <div class="row">
                                                                    <div class="button-row d-flex justify-content-end mt-4 col-12">
                                                                        <button class="btn btn-primary js-btn-prev ml-auto"
                                                                            type="button" title="Previous" style="float: left; margin:5px;background-color:#111111; color:#fff"> <i
                                                                            class="fas fa-arrow-left"></i> Previous</button>
                                                                        <button
                                                            ...
                                                            <div class="multisteps-form__content">
                                                                ...
                                                                <div class="button-row d-flex mt-4 justify-content-end">
                                                                    ...
                                                                    <button class="btn  btn-warning ml-auto"
                                                                        type="button" title="Send" style="float: right; margin:5px;">Send</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                </div>
