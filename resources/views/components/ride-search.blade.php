                        ...
                        <div class="card p-2 border-0">
                            <div class="d-flex justify-content-between text-left mb-1">
                                <div class="flex-fill m-2">
                                    ...
                                    <input type="text" id="pickup" placeholder="Enter Pickup Location" class="form-control custom-input">
                                </div>
                                <div class="flex-fill m-2">
                                    <label for="dropoff" class="text-white">Dropoff Location</label>
                                    <input type="text" id="dropoff" placeholder="Enter Dropoff Location" class="form-control custom-input">
                                </div>
                            </div>
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <div class="flex-fill m-2" style="width: 147px;">
                                    <label for="datetimepicker" class="text-white">Date</label>
                                    <input id="datetimepicker" type="text" class="form-control custom-input" placeholder="Select Date">
                                </div>
                                <div class="flex-fill m-2">
                            ...
                            <div class="text-center p-2">
                                <a href="{{url('/car-list')}}" class="btn btn-warning rounded-2 w-100">Find A Ride <i class="fa fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </form>
                </div>
