...
<footer class="light">
			<div class="mockup-right">
				<img src="{{asset('frontend-assets/images/resources/footer-mockup.png')}}" alt="">
			</div>
			<div class="container">
				<div class="row">
					<div class="col-lg-4 col-sm-6">
						<div class="widget">
							<a href="index.html" title=""><img src="{{asset('frontend-assets/./images/footer-logo.png')}}" alt=""></a>
							<p>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							...
							<i><img src="{{asset('frontend-assets/images/credit-cards.png')}}" alt=""></i>
						</div>
					</div>
				</div>
			</div>
