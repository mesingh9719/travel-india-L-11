<footer class="footer footer-default">
    ...
    <div class="footer-top sec-padding" style="background-image: url('frontend-assets/images/footer-bg.png')">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="d-sm-flex justify-content-between flex-sm-wrap">
                        ...
                        <div class="widget contact-widget">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li>Email :<a href="#"> <span class="__cf_email__"
                                                              data-cfemail="1f767179705f78727e7673317c7072">[email&#160;protected]</span></a>
                                </li>
