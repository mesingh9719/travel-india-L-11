        ...
        <div class="navbar-left">
            <div class="logo-area">
                <a class="navbar-brand" href="{{ route('admin.dashboard') }}">
                    <img class="dark" src="{{ asset('frontend-assets/images/ti-temp-logo.png') }}" alt="logo">
        ...
        <div class="navbar-right">
                ...
                <li class="nav-author">
                    <div class="dropdown-custom">
                        <a href="javascript:;" class="nav-item-toggle"><img src="{{ asset('admin-assets/img/author-nav.jpg') }}" alt="" class="rounded-circle">
                            <span class="nav-item__title">{{ auth('admin')->user()->name ?? '' }}<i class="las la-angle-down nav-item__arrow"></i></span>
                        </a>
                        <div class="dropdown-parent-wrapper">
                            <div class="dropdown-wrapper">
                                <div class="nav-author__info">
                                    <div class="author-img">
                                        <img src="{{ asset('admin-assets/img/author-nav.jpg') }}" alt="" class="rounded-circle">
                                    </div>
                                    <div>
                                        <h6>{{ auth('admin')->user()->name ?? '' }}</h6>
                                        <span>{{ auth('admin')->user()->is_super === 1 ? 'Super Admin' : '' }}</span>
                                    </div>
                                </div>
            ...
            <div class="navbar-right__mobileAction d-md-none">
                <a href="#" class="btn-search">
                    <img src="{{ asset('admin-assets/img/svg/search.svg') }}" alt="search" class="svg feather-search">
                    <img src="{{ asset('admin-assets/img/svg/x.svg') }}" alt="x" class="svg feather-x"></a>
                <a href="#" class="btn-author-action">
                    <img class="svg" src="{{ asset('admin-assets/img/svg/more-vertical.svg') }}" alt="more-vertical"></a>
            </div>
        </div>
        <!-- ends: .navbar-right -->
    </nav>
